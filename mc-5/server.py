...
from implServerSource import *
from implServerDestination import *
...
if __name__ == '__main__':
    ...
    endpointS.listen(MySourceFactory(args.source_port))

    endpointD = TCP4ServerEndpoint(reactor, args.dest_port)
    endpointD.listen(MyDestinationFactory(args.dest_port))
    reactor.run()