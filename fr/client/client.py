...
CLIENT_ARGUMENTS = [
    ...
    ['-sp', '--source-port', 'store', 22020, int, False, 'The port of the source server. Default 22020.'],
    ['-dp', '--dest-port', 'store', 22000, int, False, 'The port of the destination server. Default 22000.'],
