...
CLIENT_ARGUMENTS = [
    ...
    ['-sp', '--source-port', 'store', 8080, int, False, 'The port of the source server. Default 8080.'],
    ['-dp', '--dest-port', 'store', 8000, int, False, 'The port of the destination server. Default 8000.'],
